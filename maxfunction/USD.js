...
async function Run(db){
	...
	const content = 
	 ...
	 fs.writeFile('./text/dollar.txt', content,(err) => {
				if (err)
					console.log('dollar.txt fayliga yozishda xato bor',err);
				else {
					console.log('dollar.txt ga malumotlar yozildi!')
				}
        })
}
